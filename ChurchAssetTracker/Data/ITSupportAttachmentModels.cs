...
public class ITSupportTicketCommentAttachmentRow
{
    ...
    public string FileSizeDisplay
    {
        get
        {
            if (FileSizeBytes >= 1024 * 1024) return $"{FileSizeBytes / 1024d / 1024d:0.##} MB";
            if (FileSizeBytes >= 1024) return $"{FileSizeBytes / 1024d:0.##} KB";
            return $"{FileSizeBytes} bytes";
        }
    }
}
